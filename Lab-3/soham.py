...
print("The initial price of the call option for set 2 is", call(s,k,sigma,r,T,M))
print("The initial price of the put option for set 2 is", put(s,k,sigma,r,T,M))

...
for j in np.arange(N):
    ...
    call2d[4][0][j], put2d[4][0][j], call2d[4][1][j], put2d[4][1][j] = binomial_model(S0, K, r, sigma, A[4][j])
...
for i in range(N):
    for j in np.arange(N):
        ...
        call3d[0][4][0][i][j], put3d[0][4][0][i][j], call3d[0][4][1][i][j], put3d[0][4][1][i][j] = binomial_model(A[0][i], K, r, sigma, A[4][j])
        ...
        call3d[1][4][0][i][j], put3d[1][4][0][i][j], call3d[1][4][1][i][j], put3d[1][4][1][i][j] = binomial_model(S0, A[1][i], r, sigma, A[4][j])
        call3d[2][3][0][i][j], put3d[2][3][0][i][j], call3d[2][3][1][i][j], put3d[2][3][1][i][j] = binomial_model(S0, K, A[2][i], A[3][j], M)
        call3d[2][4][0][i][j], put3d[2][4][0][i][j], call3d[2][4][1][i][j], put3d[2][4][1][i][j] = binomial_model(S0, K, A[2][i], sigma, A[4][j])
...
def parte():
    ...
    K2 = 105
    for j in np.arange(N):
        call_e1[0][j], put_e1[0][j], call_e1[1][j], put_e1[1][j] = binomial_model(S0, K1, r, sigma, A[4][j])
        call_e2[0][j], put_e2[0][j], call_e2[1][j], put_e2[1][j] = binomial_model(S0, K2, r, sigma, A[4][j])
    fig1, ax1 = plt.subplots()
    fig2, ax2 = plt.subplots()
